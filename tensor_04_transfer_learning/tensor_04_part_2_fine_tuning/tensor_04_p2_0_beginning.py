...
def run():
    ...
    4. [Optional] Normalize the inputs to our model if it requires. Some computer vision models such as ResNetV250 
    ...
    # 5. Pass the inputs to the base_model (note: using tf.keras.applications,
