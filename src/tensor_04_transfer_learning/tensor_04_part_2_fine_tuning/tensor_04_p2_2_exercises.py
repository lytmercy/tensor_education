...
from src.helper_functions import create_tensorboard_callback, compare_histories
...
def run():
    ...
    # Set the trainable variable to True for all layers in feature_extract_model for fitting it on our data
    feature_extract_model.trainable = True

    # Remain 'trainable' variable to True for only the last 30 layers
