...
from src.helper_functions import unzip_data


class PreprocessData:

    def __init__(self, nlp_dataset_path="input/datasets/nlp_dataset/"):
...
def run():
    ...
    nlp_dataset_path = Path("input/datasets/nlp_dataset")
    train_df = pd.read_csv(nlp_dataset_path.joinpath("train.csv"))
    test_df = pd.read_csv(nlp_dataset_path.joinpath("test.csv"))
    # print(train_df.head())
