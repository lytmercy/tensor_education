...
from src.helper_functions import create_tensorboard_callback
...
TENSOR_CALLBACK_SAVE_DIR = "output/training_log/nlp_log"
...
def run():
    """08.1 Building NLP models and comparing them"""
    ...
    inputs = Input(shape=(1,), dtype="string")  # input are 1-dimensional strings
    ...
    # x_1 = text_vectorizer(input)
    # x_1 = embedding(x_1)
    # outputs_1 = Dense(1, activation="sigmoid")(x_1)
    # model_1_alt = Model(input, outputs_1, name="model_1_alternate")
