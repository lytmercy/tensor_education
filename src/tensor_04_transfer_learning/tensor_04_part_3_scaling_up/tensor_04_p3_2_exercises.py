...
from src.helper_functions import plot_loss_curves, compare_histories, load_and_prep_image

# Import class for get class names
from src.tensor_04_transfer_learning.tensor_04_part_3_scaling_up.tensor_04_p3_0_beginning import GettingData
...
from src.tensor_04_transfer_learning.tensor_04_part_3_scaling_up.tensor_04_p3_1_big_dog_model import create_model
from src.tensor_04_transfer_learning.tensor_04_part_3_scaling_up.tensor_04_p3_1_big_dog_model import compile_model
...
def run():
    ...
    mixed_model = Model(input, outputs)
